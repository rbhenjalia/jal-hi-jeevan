...
{	 
   ...
   $("#tablec").find("tr:not(:first)").remove();
    ...
    if(state==s)
   {
        ...
        c3.innerHTML = obj.Category;
	    c4.innerHTML = obj.Status;
		c5.innerHTML = obj.WaterBodyType;
...
{	 
   ...
   $("#tablew").find("tr:not(:first)").remove();
	...
	var table =  document.getElementById("tablew");
	
	
     var x = document.getElementById("WaterBodyType").selectedIndex;
     var y = document.getElementById("WaterBodyType").options;
